...
Single, self-contained page: [`index.html`](index.html).

## Live site

Hosted on GitHub Pages. Once Pages is enabled for this repo, the URL is:
...
`wordpress-theme/` contains the same design packaged as an installable
WordPress theme (`longbridge.zip`) with an install guide, for if the site
later moves to WordPress.
