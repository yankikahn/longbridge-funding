<?php
/**
 * Fallback template - renders the Woodland Financial Group landing page.
 *
 * @package Longbridge
 */
get_header();
...
<header class="site-header" id="header">
  <div class="wrap nav">
    ...
    <div class="nav-cta">
      ...
      <a href="#apply" class="btn btn-primary">Get funded</a>
    </div>
  </div>
</header>
...
<section class="hero">
  <div class="wrap hero-grid">
    ...
    <div class="hero-actions">
      <a href="#apply" class="btn btn-on-dark">See your options
...
<section class="section apply" id="apply">
  <div class="wrap apply-grid">
    <div class="reveal">
      ...
      <p class="apply-lead">Tell us a little about your business and an advisor will reach out with your options — usually the same day.</p>
      <ul class="apply-points">
        <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12l2 2 4-4"/><circle cx="12" cy="12" r="9"/></svg>Takes about three minutes</li>
        ...
        <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12l2 2 4-4"/><circle cx="12" cy="12" r="9"/></svg>Won't affect your credit score</li>
      </ul>
    </div>

    <div class="form-card reveal">
      <form id="applyForm" novalidate>
        <h3>Request your funding options</h3>
        <p class="sub">A real advisor reviews every application.</p>
        <div class="field-row">
        ...
        <div class="field"><label for="business">Business name</label><input id="business" name="business" type="text" autocomplete="organization" required /></div>
        <div class="field-row">
        ...
        <div class="field-row">
          <div class="field">
            <label for="amount">Funding needed</label>
          ...
          <div class="field">
            <label for="product">I'm interested in</label>
