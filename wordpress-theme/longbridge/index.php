...
<section class="trust">
  <div class="wrap trust-inner">
    ...
    <div class="trust-items">
      ...
      <span class="trust-item"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 6v6l4 2"/><circle cx="12" cy="12" r="9"/></svg>Decisions same day</span>
...
<section class="section how" id="how">
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <h2>From application to funded — usually the same day.</h2>
    </div>
    <div class="steps">
      ...
      <div class="step reveal">
        ...
        <p>Compare terms side by side with a person who explains the trade-offs. Accept the one that fits — funds can land in your account same day.</p>
      </div>
    </div>
  </div>
</section>
...
<footer class="site-footer">
  <div class="wrap">
    ...
    <div class="foot-bottom">
      ...
      <p><a href="<?php echo esc_url( get_privacy_policy_url() ? get_privacy_policy_url() : '#' ); ?>">Privacy Policy</a> · <a href="https://yankikahn.github.io/longbridge-funding/terms.html">Terms of Service</a></p>
    </div>
